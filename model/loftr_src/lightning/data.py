...
class MultiSceneDataModule(pl.LightningDataModule):
    ...
    def __init__(self, args, config):
        ...
        self.coarse_scale = 1 / 8  # 0.125. for training loftr.
    ...
    def _build_concat_dataset(
        ...
        # if mode == 'train':
        #     datasets.append(AutoDataset('/data3/ljz/matching/data/datasets/Oxford/', (640, 480), for_='norm', st=0))
...
class HomoDataModule(pl.LightningDataModule):
    """
    For distributed training, each training process is assgined
    only a part of the training scenes to reduce memory overhead.
    """
    ...
    def __init__(self, args, config):
        ...
        self.trainval_data_source = config.DATASET.TRAINVAL_DATA_SOURCE
        self.img_size = config.DATASET.IMG_RESIZE
        self.train_loader_params = {
            'batch_size': args.batch_size,
            'num_workers': args.num_workers,
            'pin_memory': getattr(args, 'pin_memory', True)
