...
class MegaDepthDataset(Dataset):
    def __init__(self,
        ...
        # self.pair_infos = self.pair_infos[:20]
    ...
    def __getitem__(self, idx):
        while 1:
            try:
                ...
                image0, mask0, scale0, w, h = read_megadepth_gray(
                    img_name0, self.img_resize, self.df, self.img_padding, None)
                    # np.random.choice([self.augment_fn, None], p=[0.5, 0.5]))
                image1, mask1, scale1, _, _ = read_megadepth_gray(
                ...
                idx = np.random.randint(0, len(self.pair_infos))
                print('随机重新选择！')
