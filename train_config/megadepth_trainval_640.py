...
TRAIN_BASE_PATH = "/data3/ljz/matching/data/datasets/megadepth/index"
cfg.DATASET.TRAINVAL_DATA_SOURCE = "MegaDepth"
cfg.DATASET.TRAIN_DATA_ROOT = "/data3/ljz/matching/data/datasets/megadepth/train"
...
TEST_BASE_PATH = "/data3/ljz/matching/data/datasets/megadepth/index"
cfg.DATASET.TEST_DATA_SOURCE = "MegaDepth"
cfg.DATASET.VAL_DATA_ROOT = cfg.DATASET.TEST_DATA_ROOT = "/data3/ljz/matching/data/datasets/megadepth/test"
